...
library(ggplot2)
pophealth2 <- readRDS("peopleImpact.rds")
g <- ggplot(popHealth2, aes(type, count / 1000, fill=Impact)) + geom_bar(stat="identity")
g <- g + labs(x = "Type of Event", y = "# People Affected (1,000)", title = "Total Injuries & Fatalities by Weather Category 1950 - 2011")
print(g)
```
</q>
